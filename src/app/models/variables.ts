export interface Variables {
    show: boolean;  //sets whether or not the nav link gets displayed in the header
    showChilderen:boolean;  //determines whether or not to match the exact parameter of the routerlink wehn navigating the route
